...
@section('body')
    ...
    <form action="{{route('saveBillPurchase',['id'=>$bill->id])}}" method="post" id="formStart">
        @csrf
        @method('PATCH')
        <div class="m-3">
            <div class="row">
                    ...
                    @foreach($subBills as $subBill)
                        <div class="row m-3">
                            ...
                            <div class="col-1 text-center">
                                ...
                                <a href="{{ route('updatePurchase', ['id' => $subBill->id, 'stock' => $subBill->stock, 'price' => $subBill->total_product_amount]) }}">
        ...
        <div class="m-3">
            <label id="purchase" onclick="purchase()" class="bg-primary rounded-2 p-1 m-1 bHover">Credit
                Purchase</label>
            <div class="mb-3 @if($bill->payable <= 0) d-none @endif" id="creditPurchaseContent">
                <div class="row">
                    <div class="col-5">
                        <label for="exampleInputAddress" class="">Credit Price</label>
                        <input type="number" name="payable" value="{{$bill->payable}}" class="form-control"
